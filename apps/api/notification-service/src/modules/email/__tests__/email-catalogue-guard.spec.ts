    ...
    */
    it('put no untranslated words in any email', () => {
      ...
      const render = (locale: string) => [
        ...
        autoClockOutEmail(locale, { userName: '4', locationName: '5', clockInTime: '8', clockOutTime: '9', totalHours: 2, reason: 'exceeded_duration' }),
        taskAssignedEmail(locale, { title: '1', priority: 'LOW' }),
        taskCompletedEmail(locale, { title: '1' }),
