 ...
 * Colors are dynamic based on props
 */
export function AnimatedLogo({
  className,
  size = 'default',
  primaryColor = '#2563EB', // Blue primary
  variant = 'dark', // dark = dark text for light backgrounds
}: AnimatedLogoProps) {
  ...
  return (
    <div className={`relative group ${className ?? ''}`}>
      <svg
        ...
        className={`w-auto transition-transform duration-300 group-hover:scale-105 ${heightClass}`}
      >
